-- 插入测试用户（使用MERGE INTO避免重复插入）
MERGE INTO `sk_user` (`id`, `nickname`, `password`, `salt`, `register_date`, `last_login_date`, `login_count`) KEY(`id`) VALUES
...
-- 插入商品
MERGE INTO `sk_goods` (`id`, `goods_name`, `goods_title`, `goods_img`, `goods_detail`, `goods_price`, `goods_stock`) KEY(`id`) VALUES
...
-- 插入秒杀商品
MERGE INTO `sk_goods_seckill` (`id`, `goods_id`, `seckill_price`, `stock_count`, `start_date`, `end_date`, `version`) KEY(`id`) VALUES
